...
- <b>Работа пользователя с системой</b>: управление взглядом осуществляется при помощи мыши, передвижение осуществляется при помощи клавиш W – вперёд; A – влево; S – назад; D – вправо. E - кнопка взаимодействия с окружением; Esc - открыть меню
